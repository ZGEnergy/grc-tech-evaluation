...
|-------|---------------|-------|
| A–F (Gate, Expressiveness, Extensibility, Scalability, Accessibility, Supply Chain) | v5, v7, v8 | v5 test definitions for Suites A–F are unchanged in v7 and v8. Results produced under v5 remain valid. |
| G (FNM Ingestion) | v7, v8 | Suite G was introduced in v6 and stabilized in v7. v6 results should be re-evaluated under v7 or v8. |
...
- **New results use v8.** All results produced after this protocol version is adopted must use `protocol_version: "v8"` in YAML frontmatter.

- **Mixed-version result sets are expected.** A tool evaluation may contain v5 results for Suites A–F and v7 or v8 results for Suite G. This is the normal case, not an error.
