...
| LARGE | CAISO FNM Annual S01 | ~30,000 | PSS/E v31 via intermediate format | Data model fidelity — Suite G FNM ingestion tests (FNM_PATH-gated). |
