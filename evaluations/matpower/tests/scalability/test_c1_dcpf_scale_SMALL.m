%% Test C-1: DCPF on SMALL (ACTIVSg 2000-bus)
%%
%% Dimension: scalability
%% Network: SMALL (ACTIVSg 2000-bus)
%% Pass condition: Completes DCPF on SMALL within time budget.
%% Tool: MATPOWER 8.1
...
try
    ...
    if results.success
        ...
        errors{end + 1} = 'DCPF did not converge on SMALL network';
    end
