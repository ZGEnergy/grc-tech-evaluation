"""
Test C-1: DCPF on MEDIUM

Dimension: scalability
Network: MEDIUM (ACTIVSg 10k — 10,000 buses)
Pass condition: Completes DCPF on MEDIUM. Wall-clock and peak memory recorded.
Tool: PyPSA 1.1.2
"""
...
def run(network_file: str = DEFAULT_NETWORK, timeseries_dir: str | None = None) -> dict:
    """Execute DC Power Flow on ACTIVSg10k (10,000-bus). Run 3 times, report median.
    ...
    try:
        ...
        results["details"]["cpu_threads_used"] = 1  # n.lpf() is single-threaded
        print(
