"""Shared fixtures for pypsa gate and rubric-dimension tests."""
...
# evaluations/pypsa/tests/conftest.py -> evaluations/pypsa/tests/
#   -> evaluations/pypsa/ -> evaluations/ -> repo root -> data/networks/
