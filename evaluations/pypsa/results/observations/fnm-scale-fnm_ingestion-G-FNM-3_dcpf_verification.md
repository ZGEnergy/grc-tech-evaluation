...
# Observation: PyPSA DCPF scales to ~28,000-bus FNM with 40s solve time and 16 GB memory

## Finding

PyPSA's linear power flow (`n.lpf()`) solves the ~28,000-bus FNM main island (~33,000
active branches, 9,481 transformers, ~5,700 generators, 8,624 loads) in 40.1 seconds
...
The ~28,000-bus network is the largest case in the evaluation suite. The high memory usage
...
reference, the cleaned MATPOWER .m file represents ~~28,000 buses in a compact matrix
